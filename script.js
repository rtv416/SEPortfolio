function lerp(start, end, t) {
  ...
  function initializeSlider(projectId) {
    ...
    // Auto advance slides - Removed as per update request
  ...
  document.querySelectorAll(".project-btn").forEach((button) => {
    button.addEventListener("click", (e) => {
      if (e.target.classList.contains("documentation-btn")) {
        console.log("Documentation button clicked")
      } else if (e.target.classList.contains("recommendation-btn")) {
        console.log("Letter of Recommendation button clicked")
      } else if (e.target.classList.contains("algorithm-btn")) {
        console.log("Algorithm button clicked")
      } else if (e.target.classList.contains("servicenow-btn")) {
        console.log("ServiceNow Data button clicked")
      } else if (e.target.classList.contains("playstore-btn")) {
